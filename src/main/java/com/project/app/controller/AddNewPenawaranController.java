    ...
    public void showDetailPenawaran(int spId) {
        ...
        for (var d : data) {
            ...
            if (!jobGroup.containsKey(d.jobId)) {
                ...
                HBox.setHgrow(jobContainer, Priority.ALWAYS);
                VBox.setVgrow(jobContainer, Priority.NEVER);

                VBox jobBox = new VBox(6);

                String deskripsiValidator = (d.deskripsiPekerjaan == null) ? "---" : d.deskripsiPekerjaan;
                ...
                Label p4 = new Label("📄 Deskripsi : " + deskripsiValidator);
                ...
                jobBox.getChildren().addAll(p1, p2, p3, p4, new Separator());

                jobContainer.getChildren().add(jobBox);
