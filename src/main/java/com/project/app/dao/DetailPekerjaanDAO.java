...
public class DetailPekerjaanDAO {
    ...
    public void insertDetailPekerjaan(DetailPekerjaan detail) throws SQLException {
    ...
    public void insertDetailPekerjaanBatch(List<DetailPekerjaan> details) throws SQLException {
        String sql = "INSERT INTO detail_pekerjaan (job_id, component_id, qty, harga_aktual) " +
                "VALUES (?, ?, ?, ?)";

        try (PreparedStatement pstmt = connection.prepareStatement(sql)) {
            for (DetailPekerjaan detail : details) {
                pstmt.setLong(1, detail.getJobId());
                pstmt.setLong(2, detail.getComponentId());
                pstmt.setInt(3, detail.getQty());
                pstmt.setDouble(4, detail.getHargaAktual());
    ...
    public List<DetailPekerjaan> getDetailByJobId(Long jobId) throws SQLException {
        List<DetailPekerjaan> details = new ArrayList<>();
    ...
    public boolean updateDetailPekerjaan(DetailPekerjaan detail) throws SQLException {
